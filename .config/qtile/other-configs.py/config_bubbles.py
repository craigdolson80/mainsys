    ...
    Screen(
        top=bar.Bar(
            [            
                ...
                widget.Image(
                            filename = "~/.config/qtile/colors/dracula/cyan_left.png",
                            scale = "False"
                           ), 
                 widget.TextBox(
                               text = '',
                ...
                widget.Image(
                             filename = "~/.config/qtile/colors/dracula/cyan_right.png",
                             scale = "False"
                            ),
                widget.Sep(
                           linewidth = 0,
                ...
                widget.CPU(
                 ...
                 widget.Image(
                             filename = "~/.config/qtile/colors/dracula/purple_right_end.png",
                             scale = "False"
                            ),
                widget.Sep(
                           linewidth = 0,
                ...
                widget.Image(
                             filename = "~/.config/qtile/colors/dracula/pink_left_end.png",
                             scale = "False"
                             ),
                widget.TextBox(
                               text = '',
                ...
                widget.Image(
                             filename = "~/.config/qtile/colors/dracula/pink_right_end.png",
                             scale = "False"
                             ),                       
                widget.Sep(
                           linewidth = 0,
...
Screen(
        top=bar.Bar(
            [            
                ...
                widget.Systray(),
                widget.Image(
                             filename = "~/.config/qtile/colors/dracula/leading_dark_end.png",
                             scale = "False"
                            ),
                widget.TextBox(
                              text = '',
